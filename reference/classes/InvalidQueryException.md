[directus-monorepo](../README.md) / [Modules](../modules.md) / InvalidQueryException
...
- [constructor](InvalidQueryException.md#constructor)

### Properties

- [cause](InvalidQueryException.md#cause)
- [code](InvalidQueryException.md#code)
- [extensions](InvalidQueryException.md#extensions)
- [message](InvalidQueryException.md#message)
- [name](InvalidQueryException.md#name)
- [stack](InvalidQueryException.md#stack)
- [status](InvalidQueryException.md#status)
- [prepareStackTrace](InvalidQueryException.md#preparestacktrace)
- [stackTraceLimit](InvalidQueryException.md#stacktracelimit)

### Methods

- [captureStackTrace](InvalidQueryException.md#capturestacktrace)
...
[api/src/exceptions/invalid-query.ts:4](https://github.com/directus/directus/blob/953c2f95d/api/src/exceptions/invalid-query.ts#L4)
