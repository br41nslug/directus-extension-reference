[directus](../README.md) / [Modules](../modules.md) / [services](../modules/services.md) / FilesService

# Class: FilesService

[services](../modules/services.md).FilesService
...
- [constructor](services.FilesService.md#constructor)

### Properties

- [accountability](services.FilesService.md#accountability)
- [cache](services.FilesService.md#cache)
- [collection](services.FilesService.md#collection)
- [eventScope](services.FilesService.md#eventscope)
- [knex](services.FilesService.md#knex)
- [schema](services.FilesService.md#schema)

### Methods

- [createMany](services.FilesService.md#createmany)
- [createOne](services.FilesService.md#createone)
- [deleteByQuery](services.FilesService.md#deletebyquery)
- [deleteMany](services.FilesService.md#deletemany)
- [deleteOne](services.FilesService.md#deleteone)
- [getKeysByQuery](services.FilesService.md#getkeysbyquery)
- [getMetadata](services.FilesService.md#getmetadata)
- [importOne](services.FilesService.md#importone)
- [readByQuery](services.FilesService.md#readbyquery)
- [readMany](services.FilesService.md#readmany)
- [readOne](services.FilesService.md#readone)
- [readSingleton](services.FilesService.md#readsingleton)
- [updateBatch](services.FilesService.md#updatebatch)
- [updateByQuery](services.FilesService.md#updatebyquery)
- [updateMany](services.FilesService.md#updatemany)
- [updateOne](services.FilesService.md#updateone)
- [uploadOne](services.FilesService.md#uploadone)
- [upsertMany](services.FilesService.md#upsertmany)
- [upsertOne](services.FilesService.md#upsertone)
- [upsertSingleton](services.FilesService.md#upsertsingleton)
...
[api/src/services/files.ts:26](https://github.com/directus/directus/blob/9368dbd0c/api/src/services/files.ts#L26)
...
[api/src/services/files.ts:282](https://github.com/directus/directus/blob/9368dbd0c/api/src/services/files.ts#L282)
...
[api/src/services/files.ts:302](https://github.com/directus/directus/blob/9368dbd0c/api/src/services/files.ts#L302)
...
[api/src/services/files.ts:294](https://github.com/directus/directus/blob/9368dbd0c/api/src/services/files.ts#L294)
...
| `allowList` | `any` | `env.FILE_METADATA_ALLOW_LIST` |
...
[api/src/services/files.ts:132](https://github.com/directus/directus/blob/9368dbd0c/api/src/services/files.ts#L132)
...
[api/src/services/files.ts:241](https://github.com/directus/directus/blob/9368dbd0c/api/src/services/files.ts#L241)
...
[api/src/services/files.ts:33](https://github.com/directus/directus/blob/9368dbd0c/api/src/services/files.ts#L33)
