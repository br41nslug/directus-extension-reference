[directus](../README.md) / [Modules](../modules.md) / [services](../modules/services.md) / PresetsService

# Class: PresetsService

[services](../modules/services.md).PresetsService
...
- [constructor](services.PresetsService.md#constructor)

### Properties

- [accountability](services.PresetsService.md#accountability)
- [cache](services.PresetsService.md#cache)
- [collection](services.PresetsService.md#collection)
- [eventScope](services.PresetsService.md#eventscope)
- [knex](services.PresetsService.md#knex)
- [schema](services.PresetsService.md#schema)

### Methods

- [createMany](services.PresetsService.md#createmany)
- [createOne](services.PresetsService.md#createone)
- [deleteByQuery](services.PresetsService.md#deletebyquery)
- [deleteMany](services.PresetsService.md#deletemany)
- [deleteOne](services.PresetsService.md#deleteone)
- [getKeysByQuery](services.PresetsService.md#getkeysbyquery)
- [readByQuery](services.PresetsService.md#readbyquery)
- [readMany](services.PresetsService.md#readmany)
- [readOne](services.PresetsService.md#readone)
- [readSingleton](services.PresetsService.md#readsingleton)
- [updateBatch](services.PresetsService.md#updatebatch)
- [updateByQuery](services.PresetsService.md#updatebyquery)
- [updateMany](services.PresetsService.md#updatemany)
- [updateOne](services.PresetsService.md#updateone)
- [upsertMany](services.PresetsService.md#upsertmany)
- [upsertOne](services.PresetsService.md#upsertone)
- [upsertSingleton](services.PresetsService.md#upsertsingleton)
