...
[directus-monorepo](../API.md) > ActivityService
...
> **new ActivityService**(`options`): [`ActivityService`](class.ActivityService.md)
...
> **notificationsService**: [`NotificationsService`](class.NotificationsService.md)
