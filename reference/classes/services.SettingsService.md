[directus](../README.md) / [Modules](../modules.md) / [services](../modules/services.md) / SettingsService

# Class: SettingsService

[services](../modules/services.md).SettingsService
...
- [constructor](services.SettingsService.md#constructor)

### Properties

- [accountability](services.SettingsService.md#accountability)
- [cache](services.SettingsService.md#cache)
- [collection](services.SettingsService.md#collection)
- [eventScope](services.SettingsService.md#eventscope)
- [knex](services.SettingsService.md#knex)
- [schema](services.SettingsService.md#schema)

### Methods

- [createMany](services.SettingsService.md#createmany)
- [createOne](services.SettingsService.md#createone)
- [deleteByQuery](services.SettingsService.md#deletebyquery)
- [deleteMany](services.SettingsService.md#deletemany)
- [deleteOne](services.SettingsService.md#deleteone)
- [getKeysByQuery](services.SettingsService.md#getkeysbyquery)
- [readByQuery](services.SettingsService.md#readbyquery)
- [readMany](services.SettingsService.md#readmany)
- [readOne](services.SettingsService.md#readone)
- [readSingleton](services.SettingsService.md#readsingleton)
- [updateBatch](services.SettingsService.md#updatebatch)
- [updateByQuery](services.SettingsService.md#updatebyquery)
- [updateMany](services.SettingsService.md#updatemany)
- [updateOne](services.SettingsService.md#updateone)
- [upsertMany](services.SettingsService.md#upsertmany)
- [upsertOne](services.SettingsService.md#upsertone)
- [upsertSingleton](services.SettingsService.md#upsertsingleton)
...
[api/src/services/settings.ts:5](https://github.com/directus/directus/blob/9368dbd0c/api/src/services/settings.ts#L5)
