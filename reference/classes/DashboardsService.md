[directus-monorepo](../README.md) / [Modules](../modules.md) / DashboardsService
...
- [constructor](DashboardsService.md#constructor)

### Properties

- [accountability](DashboardsService.md#accountability)
- [cache](DashboardsService.md#cache)
- [collection](DashboardsService.md#collection)
- [eventScope](DashboardsService.md#eventscope)
- [knex](DashboardsService.md#knex)
- [schema](DashboardsService.md#schema)

### Methods

- [createMany](DashboardsService.md#createmany)
- [createOne](DashboardsService.md#createone)
- [deleteByQuery](DashboardsService.md#deletebyquery)
- [deleteMany](DashboardsService.md#deletemany)
- [deleteOne](DashboardsService.md#deleteone)
- [getKeysByQuery](DashboardsService.md#getkeysbyquery)
- [readByQuery](DashboardsService.md#readbyquery)
- [readMany](DashboardsService.md#readmany)
- [readOne](DashboardsService.md#readone)
- [readSingleton](DashboardsService.md#readsingleton)
- [updateBatch](DashboardsService.md#updatebatch)
- [updateByQuery](DashboardsService.md#updatebyquery)
- [updateMany](DashboardsService.md#updatemany)
- [updateOne](DashboardsService.md#updateone)
- [upsertMany](DashboardsService.md#upsertmany)
- [upsertOne](DashboardsService.md#upsertone)
- [upsertSingleton](DashboardsService.md#upsertsingleton)
...
[api/src/services/dashboards.ts:5](https://github.com/directus/directus/blob/953c2f95d/api/src/services/dashboards.ts#L5)
