[directus](../README.md) / [Modules](../modules.md) / [services](../modules/services.md) / FoldersService

# Class: FoldersService

[services](../modules/services.md).FoldersService
...
- [constructor](services.FoldersService.md#constructor)

### Properties

- [accountability](services.FoldersService.md#accountability)
- [cache](services.FoldersService.md#cache)
- [collection](services.FoldersService.md#collection)
- [eventScope](services.FoldersService.md#eventscope)
- [knex](services.FoldersService.md#knex)
- [schema](services.FoldersService.md#schema)

### Methods

- [createMany](services.FoldersService.md#createmany)
- [createOne](services.FoldersService.md#createone)
- [deleteByQuery](services.FoldersService.md#deletebyquery)
- [deleteMany](services.FoldersService.md#deletemany)
- [deleteOne](services.FoldersService.md#deleteone)
- [getKeysByQuery](services.FoldersService.md#getkeysbyquery)
- [readByQuery](services.FoldersService.md#readbyquery)
- [readMany](services.FoldersService.md#readmany)
- [readOne](services.FoldersService.md#readone)
- [readSingleton](services.FoldersService.md#readsingleton)
- [updateBatch](services.FoldersService.md#updatebatch)
- [updateByQuery](services.FoldersService.md#updatebyquery)
- [updateMany](services.FoldersService.md#updatemany)
- [updateOne](services.FoldersService.md#updateone)
- [upsertMany](services.FoldersService.md#upsertmany)
- [upsertOne](services.FoldersService.md#upsertone)
- [upsertSingleton](services.FoldersService.md#upsertsingleton)
