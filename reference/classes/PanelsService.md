[directus-monorepo](../README.md) / [Modules](../modules.md) / PanelsService
...
- [constructor](PanelsService.md#constructor)

### Properties

- [accountability](PanelsService.md#accountability)
- [cache](PanelsService.md#cache)
- [collection](PanelsService.md#collection)
- [eventScope](PanelsService.md#eventscope)
- [knex](PanelsService.md#knex)
- [schema](PanelsService.md#schema)

### Methods

- [createMany](PanelsService.md#createmany)
- [createOne](PanelsService.md#createone)
- [deleteByQuery](PanelsService.md#deletebyquery)
- [deleteMany](PanelsService.md#deletemany)
- [deleteOne](PanelsService.md#deleteone)
- [getKeysByQuery](PanelsService.md#getkeysbyquery)
- [readByQuery](PanelsService.md#readbyquery)
- [readMany](PanelsService.md#readmany)
- [readOne](PanelsService.md#readone)
- [readSingleton](PanelsService.md#readsingleton)
- [updateBatch](PanelsService.md#updatebatch)
- [updateByQuery](PanelsService.md#updatebyquery)
- [updateMany](PanelsService.md#updatemany)
- [updateOne](PanelsService.md#updateone)
- [upsertMany](PanelsService.md#upsertmany)
- [upsertOne](PanelsService.md#upsertone)
- [upsertSingleton](PanelsService.md#upsertsingleton)
...
[api/src/services/panels.ts:5](https://github.com/directus/directus/blob/953c2f95d/api/src/services/panels.ts#L5)
