...
[directus-monorepo](../API.md) > PanelsService
...
> **new PanelsService**(`options`): [`PanelsService`](class.PanelsService.md)
...
[api/src/services/panels.ts:5](https://github.com/directus/directus/blob/67c008df3/api/src/services/panels.ts#L5)
