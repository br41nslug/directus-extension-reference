...
[directus-monorepo](../API.md) > SharesService
...
> **new SharesService**(`options`): [`SharesService`](class.SharesService.md)
...
[api/src/services/shares.ts:26](https://github.com/directus/directus/blob/3a4abb10c/api/src/services/shares.ts#L26)
...
[api/src/services/shares.ts:24](https://github.com/directus/directus/blob/3a4abb10c/api/src/services/shares.ts#L24)
...
[api/src/services/shares.ts:36](https://github.com/directus/directus/blob/3a4abb10c/api/src/services/shares.ts#L36)
...
Send a link to the given share ID to the given email(s). Note: you can only send a link to a share if you have read
access to that particular share
...
[api/src/services/shares.ts:122](https://github.com/directus/directus/blob/3a4abb10c/api/src/services/shares.ts#L122)
...
[api/src/services/shares.ts:41](https://github.com/directus/directus/blob/3a4abb10c/api/src/services/shares.ts#L41)
