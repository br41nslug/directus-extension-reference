...
[directus-monorepo](../API.md) > PresetsService
...
> **new PresetsService**(`options`): [`PresetsService`](class.PresetsService.md)
...
[api/src/services/presets.ts:5](https://github.com/directus/directus/blob/67c008df3/api/src/services/presets.ts#L5)
