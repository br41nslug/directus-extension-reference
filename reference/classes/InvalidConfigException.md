[directus-monorepo](../README.md) / [Modules](../modules.md) / InvalidConfigException
...
[api/src/exceptions/invalid-config.ts:4](https://github.com/directus/directus/blob/953c2f95d/api/src/exceptions/invalid-config.ts#L4)
